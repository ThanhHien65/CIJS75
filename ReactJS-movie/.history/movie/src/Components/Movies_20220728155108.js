...
const Movies = () => {
  ...
  useEffect(() => {
    getupcoming.then((response) => {
      const random = Math.flo
      setData([...data, response.data.results[1]]);
      getdirector(response.data.results[1].id).then((response) => {
      ...
      gettrailer(response.data.results[1].id).then((response) => {
