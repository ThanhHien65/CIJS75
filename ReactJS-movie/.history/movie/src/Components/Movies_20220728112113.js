...
const Movies = () => {
  ...
  useEffect(() => {
    ...
    getupcoming.then((response) => {
      ...
      idredictor = response.data.results[0].id;
    });
    getdirector(idredictor).then((response) => {
      SetInfodirector(response.data);
      console.log(idredictor);
    });
  }, []);
  return (
    <div>
