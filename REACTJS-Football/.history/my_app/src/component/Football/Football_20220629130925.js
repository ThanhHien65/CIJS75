...
export const Football = () => {
    ...
    const fillPlayer = () => { 
        const fillName = add.map((item)=>item.name).filter((v,i,vIds)=>vIds.indexOf(v) !== i)
    ...
    return (
        <div>
            ...
            <div><button className="addPlayer" onClick={AddPlayer}>Add Player +</button></div>
            <div><button className="FillPlayer" onClick={fillPlayer}>Fill Player</button></div>
            <div><button className="addPlayer" onClick={removePlayer}>Remove Player -</button></div>
            <div className="container">
                <form action="" className="informationPlay"></form>
            </div>
            <div className="informationPlayer">
                {add.map((item,index)=>{
                    return(
                        <div className='Moredetails'>
                            <div className="Delete" onClick={Choice} value={index}>x</div>
