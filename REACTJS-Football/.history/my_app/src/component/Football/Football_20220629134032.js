...
export const Football = () => {
  ...
  const createPlayer = () => {
    console.log("aaa");
    const age = document.getElementByCl("fage").value;
    const name = document.getElementsByClassName("fname").value;
    const fpostition = document.getElementsByClassName("fposition").value;
  };
  return (
    <div>
      ...
      <div className="container">
        <form action="" className="informationPlay" onsubmit="return false">
          ...
          <div className="submit">
            <button className="submited" onClick={createPlayer}>
              Submit
            </button>
          </div>
        </form>
